...
/*     if(user?.uid){
  ...
  return (
    <div className="flex justify-center items-center relative min-h-screen">
        <img src="https://static.vecteezy.com/system/resources/previews/007/164/537/original/fingerprint-identity-sensor-data-protection-system-podium-hologram-blue-light-and-concept-free-vector.jpg" alt="loginBG" className="absolute z-[-1] object-cover"/>
      <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 bg-slate-400 bg-opacity-[40%] dark:text-gray-100">
        ...
        <p className="text-sm text-center dark:text-gray-200">
          ...
          <Link
            ...
            className="ml-1 text-blue-400 focus:underline hover:underline"
          >
            Sign up here
          </Link>
        </p>
