...
const AddService = () => {
  ...
  const onSubmit = (data) => {
    axios
      .post(
        "https://assignment-11-server-lyart-rho.vercel.app/add-service",
        data
      )
      .then((res) => {
        console.log(res);
        ...
        <div className="container mx-auto bg-white dark:bg-gray-800 rounded">
          <div className="xl:w-full border-b border-gray-300 dark:border-gray-700 py-5 bg-white dark:bg-gray-800">
            <div className="flex w-11/12 mx-auto xl:w-full xl:mx-0 items-center">
              <p className="text-xl text-gray-800 dark:text-gray-100 font-bold">
                Add a Service
              </p>
            </div>
          </div>
            ...
            <div className="xl:w-9/12 w-11/12 mx-auto xl:mx-0">
              ...
              <div className="mt-3 flex flex-col w-full">
                ...
                <input
                  ...
                  required
                  className="border border-gray-300 dark:border-gray-700 pl-3 py-3 shadow-sm rounded text-sm focus:outline-none focus:border-indigo-700 bg-transparent placeholder-gray-500 text-gray-500 dark:text-gray-400"
                  placeholder="Give a image url relevant to your service"
                />
              </div>
              {/* Ratings  */}
              <div className="mt-3 flex flex-col w-full">
                ...
                <input
                  ...
                  required
                  className="border border-gray-300 dark:border-gray-700 pl-3 py-3 shadow-sm rounded text-sm focus:outline-none focus:border-indigo-700 bg-transparent placeholder-gray-500 text-gray-500 dark:text-gray-400"
                  placeholder="Give us a initial ratings between 1 to 5"
                />
              </div>
              {/* Short Description  */}
              <div className="mt-3 flex flex-col w-full">
                ...
                <textarea
                  ...
                  required
                  className="border border-gray-300 dark:border-gray-700 pl-3 py-3 shadow-sm rounded text-sm focus:outline-none focus:border-indigo-700 bg-transparent placeholder-gray-500 text-gray-500 dark:text-gray-400"
                  placeholder="Write a short description within 200 Words..."
                />
              </div>
              {/* Details Description  */}
              <div className="mt-3 flex flex-col w-full">
                ...
                <textarea
                  ...
                  required
                  className="border border-gray-300 dark:border-gray-700 pl-3 py-3 shadow-sm rounded text-sm focus:outline-none focus:border-indigo-700 bg-transparent placeholder-gray-500 text-gray-500 dark:text-gray-400"
                  placeholder="Write a details description within 500 Words..."
                />
              </div>
