  ...
  return (
    <div>
        ...
        <div className="bg-violet-700 hero-left h-[90%] max-h-[600px] min-h-[400px]">
          <div className="flex top-10 flex-col h-full justify-center px-10">
            ...
            <h1 className="font-blackHan text-white text-4xl">
              <span className="text-purple-900">Solicitory</span> <br />
            ...
            <p className="text-slate-200">
              ...
              through interoperable services. Efficiently innovate open-source
              infrastructures via inexpensive materials.
            </p>
          </div>
        </div>
        <div className="h-[90%] max-h-[600px] mt-[-65px] md:mt-0 w-full md:relative">
      ...
      <div className="my-10 mt-[1000px] md:mt-[750px]">
        <div className="parallax-style h-[400px] grid grid-cols-1 md:grid-cols-2 items-center" style={parallaxStyle}>
            <div className="px-7">
                <h1 className="text-white font-blackHan text-3xl">GET FREE TRAINING ON BUSINESS DEVELOPMENT BY JOHN SMITH </h1>
            ...
            <div className="w-full flex justify-center">
                <div className="max-w-[500px] bg-slate-100 text-gray-700 p-10">
                    ...
                    <form action="" className="flex flex-col gap-5 mt-7 transition-all">
                        <input type="text" name="name" id="" placeholder="Your Name" className="border-none py-3 shadow-md" />
                        <input type="email" name="email" id="" placeholder="Your Email" className="border-none py-3 shadow-md"/>
                        <button type="submit" className="bg-gray-400 py-3 font-bold text-white">Submit</button>
                    </form>
                </div>
            </div>
        </div>
